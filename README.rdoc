...
== Fresh start
If you want to make a new rails project, I recommend to clone this repository and replace the words "capistrano_deploy" and "CapistranoDeploy" with the name of your project.
